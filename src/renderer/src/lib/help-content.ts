    ...
    zones: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Session Templates', detail: 'Save and reuse session configurations. Right-click a session → Save as Template to save the name, working directory, and role. The New Session button shows a template picker when templates exist. Manage templates in Settings → Session Templates — edit any field (name, description, model, directory, role, prompt, permissions) via the pencil button.', icon: 'BookTemplate' },
