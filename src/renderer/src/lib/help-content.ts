    ...
    zones: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Model badge', detail: 'Shows which Claude model a session is using (opus, sonnet, haiku). Only appears when --model is explicitly set. Hover to see the full model string. Hidden when using your default model.' },
