    ...
    zones: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'File conflict badge', detail: 'Amber "⚠ N" badge appears when another running session in the same directory and branch has uncommitted changes to the same file(s). Hover to see which files overlap and which sessions they conflict with. Checked every 30 seconds. Disappears when the overlap resolves (session exits or files are committed).' },
