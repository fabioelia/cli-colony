  ...
  sessions: {
    ...
    zones: [
      ...
      },
      {
        ...
        items: [
          { label: '+ New Session', detail: 'Opens a dialog to create a Claude CLI session. Set a name, working directory, color, model, agent, CLI backend, permission mode, optional CLI args, MCP servers, and custom environment variables. Keyboard shortcut: Cmd+N.', icon: 'Plus' },
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Session Templates', detail: 'Save and reuse full session configurations. Right-click a session → Save as Template to capture name, working directory, role, model, color, CLI backend, MCP servers, and agent. The New Session button shows a template picker when templates exist. Manage templates in Settings → Session Templates — edit any field, duplicate a template to create quick variants, or delete.', icon: 'BookTemplate' },
