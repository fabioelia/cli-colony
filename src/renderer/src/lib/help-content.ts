    ...
    zones: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'GET /api/pipelines/:name/runs', detail: 'Returns the run history for a named pipeline. Response: { pipeline, runs: [...] } sorted newest-first. Optional ?limit=N caps results (max 20). Includes success, durationMs, totalCost, sessionIds per entry. Use for monitoring dashboards and failure alerting.' },
