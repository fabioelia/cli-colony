    ...
    zones: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Success rate badge', detail: 'Shows N/M ✓ (card) or XX% (list) — successes over the last 10 runs. Green ≥80%, amber 50–79%, red <50%. Hidden until a pipeline has ≥3 runs. Hover for full counts. Sort by "Success Rate" to surface unreliable pipelines first.' },
