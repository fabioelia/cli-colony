    ...
    zones: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Multi-select', detail: 'Check the checkbox on each file row (Working Tree mode only) to select it. Shift+click selects a range; the checkbox click does not open the diff. When 2+ files are checked, a bulk action bar appears above the list: Stage All, Unstage All, Revert All, Select All, Deselect All. Selected files are lightly highlighted. Selection clears on any refresh.', icon: 'CheckCircle' },
