    ...
    zones: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Playbook', detail: 'When playbooks exist in ~/.claude-colony/playbooks/, a Playbook dropdown appears above the Name field. Selecting a playbook pre-fills name, model, agent, working directory, prompt, permission mode, and tags — any field can be overridden before creating. Playbooks are YAML files that bundle session configuration into reusable blueprints. Tags from the playbook are auto-applied to the session on creation.' },
