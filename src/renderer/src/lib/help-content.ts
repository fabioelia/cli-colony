    ...
    zones: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Attach JIRA Ticket', detail: 'Attach a JIRA ticket by key (e.g. NP-7663) and its title + description will be prepended to your prompt. Type the key and press Enter or leave the field — the ticket is fetched and a preview shown. Click "My Tickets" to open a picker of your open assigned tickets (sorted by recently updated) — select one to auto-fill the key. Requires Jira credentials in Settings → Integrations.', icon: 'Link' },
