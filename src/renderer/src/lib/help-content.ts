    ...
    zones: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Memory tab', detail: 'View and edit a persona\'s structured memory. Click a situation status badge to cycle it (pending → done → delegated → blocked). Use the + button next to "Active Situations" or "Learnings" to add new entries via an inline form. Hover any row for a remove button. Session log has a "clear old" button that keeps only the last 5 entries.', icon: 'Brain' },
