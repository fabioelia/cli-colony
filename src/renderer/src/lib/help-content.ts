    ...
    zones: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Export Handoff Doc', detail: 'Generates a markdown snapshot of the session — git commits, terminal output, and metadata including cost, duration, token usage, model, role, and permission mode — ready to paste into a new session to restore context. Click "✨ Generate Summary" inside the dialog to replace the raw terminal snapshot with an AI-generated 3–5 sentence summary.', icon: 'FileDown' },
          ...
          { label: 'Session Templates', detail: 'Save and reuse session configurations. Right-click a session → Save as Template to save the name, working directory, and role. The New Session button shows a template picker when templates exist. Manage templates in Settings → Session Templates — edit any field, duplicate a template to create quick variants, or delete.', icon: 'BookTemplate' },
    ...
    zones: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Edit persona settings', detail: 'Click the Pencil icon (list view) to open a quick-edit modal for schedule, model, max sessions, cost cap, and enabled state — without touching the raw markdown.', icon: 'Pencil' },
