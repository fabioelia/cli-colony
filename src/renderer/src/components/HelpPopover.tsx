...
import {
  ...
  Trophy, BarChart3, Globe, Navigation, ArrowRight, BookTemplate, Wand2, Hourglass,
} from 'lucide-react'
...
const iconMap: Record<string, LucideIcon> = {
  ...
  ClipboardList, GitCommit, Trophy, BarChart3, Globe, Navigation, ArrowRight, BookTemplate, Wand2, Hourglass,
}
