...
import {
  ...
  GitBranch, Info, GitFork, User, Bell, BellRing, Eye, FileDown, StickyNote, Clock, Network, ArrowUpDown,
  ...
  Circle, Users, Layers, CheckSquare, ListChecks, Gavel, ExternalLink, Palette, FileDiff,
} from 'lucide-react'
...
const iconMap: Record<string, LucideIcon> = {
  ...
  Download, Upload, ArrowLeft, Brain, FileText, MessageSquare, Search,
  Filter, Zap, Square, Terminal, FolderOpen, Stethoscope, Trash2,
  GitBranch, Info, GitFork, HelpCircle, ChevronDown, User, Bell, BellRing, Eye, FileDown,
