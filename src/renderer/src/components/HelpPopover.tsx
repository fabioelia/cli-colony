...
import {
  ...
  History, Cloud, ChevronsRight, Clipboard, ListOrdered, Crosshair, FileCode, GitCompareArrows, CalendarDays, BookOpen,
  Cpu, ClipboardPaste, Folder, CircleDot, FlaskConical,
} from 'lucide-react'
