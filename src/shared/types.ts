...
export interface SessionArtifactCommit {
  hash: string
  shortMsg: string
}
...
export interface SessionArtifact {
  ...
  sessionName: string
  personaName?: string
  createdAt: string           // ISO timestamp of collection
  ...
  gitBranch: string | null
  gitRepo: string | null
  commits: SessionArtifactCommit[]
  changes: GitDiffEntry[]
  totalInsertions: number
  totalDeletions: number
  summary: string             // one-line human-readable summary of what the session did
  costUsd?: number
  pipelineRunId?: string      // if generated by a pipeline
}
